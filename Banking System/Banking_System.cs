...
class Banking_System
{
    ...
    public Banking_System()
    {
        ...
        Console.Title = "Madaras Banking System";
        Console.ForegroundColor = ConsoleColor.White;
    }
    private int MainMenu()
    {
        Console.Clear();
        Center("**** Welcome to Madaras Banking System ****\n");
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | Welcome " + User.Title + ". " + User.Name + " ****\n");
        Console.BackgroundColor = ConsoleColor.DarkBlue;
        DrawLine();
        Console.WriteLine("|{0}|", AlignText(0, ""));
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | Signup Page ****\n");
        DrawLine();
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | About Us ****\n");
        Console.BackgroundColor = ConsoleColor.DarkBlue;
        DrawLine();
        Console.WriteLine("|{0}|", AlignText(0, ""));
        Console.WriteLine("|{0}|", AlignText(34, "Madaras Banking System v1.2.0.8"));
        Console.WriteLine("|{0}|", AlignText(35, "Developed By Madara Bowattage"));
        Console.WriteLine("|{0}|", AlignText(0, ""));
        DrawLine();
        Console.BackgroundColor = ConsoleColor.Black;
    }
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | Deposit Money ****\n");
        DrawLine();
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | Withdraw Money ****\n");
        DrawLine();
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | Transfer Money ****\n");
        DrawLine();
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | Account Details ****\n");
        Console.BackgroundColor = ConsoleColor.DarkBlue;
        DrawLine();
        Console.WriteLine("|{0}|",AlignText(0, ""));
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | Login Page ****\n");
        DrawLine();
    ...
    {
        Console.Clear();
        Center("**** Madaras Banking System | My Passbook ****\n");
        Console.BackgroundColor = ConsoleColor.DarkBlue;
        DrawLine();
